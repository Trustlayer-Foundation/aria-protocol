...
published at **[aria.bar/spec](https://aria.bar/spec)** (27 sections, CC-BY-4.0). This
...
| Twelve invariants that cannot change | [`../INVARIANTS.md`](../INVARIANTS.md) |
...
summarized at aria.bar/spec §02 and §05. Their full texts are published there.
